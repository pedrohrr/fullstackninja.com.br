...
O **FullStackNinja** entende e respeita a sua privacidade.
...
-   O **FullStackNinja** não armazena qualquer informação
    pessoal de seus leitores como nome, endereço ou qualquer outro dado
    que possa identificá-lo fora da Web.
-   O servidor do **FullStackNinja** armazena automaticamente
...
O **FullStackNinja** não utiliza qualquer dado coletado para
